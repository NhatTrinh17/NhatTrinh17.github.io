...
var inputSliders = $$("input[name='slider']")
var sliderList = $$(".container-slider__img")

Array.from(inputSliders).forEach(function(inputSlider, index){
    inputSlider.onclick = function(){
        inputSlider.checked
